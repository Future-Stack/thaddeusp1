...
function MyVouchers() {
  return (
    <div className="py-6">
      ...
      <div className='max-w-246.5 mx-auto'>
        <AnimationWrapper animationType="fadeUp" delay={0.2}>
          <div className="bg-white rounded-4xl overflow-hidden shadow-2xl border border-gray-100 mb-8">
            {/* Voucher Header */}
            ...
            <div className="p-6 md:p-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 pb-10 border-b border-dashed border-gray-200">
                ...
                <div className="bg-orange-50/30 rounded-3xl p-6 border border-orange-100 border-dashed">
