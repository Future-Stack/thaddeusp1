        ...
        <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-8 md:p-12 relative">
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-4 bg-[#0B1221] text-white font-bold text-[16px] rounded-xl hover:bg-[#151D2F] transition-all duration-300 active:scale-[0.98] shadow-lg shadow-[#0B1221]/20 mt-4 cursor-pointer flex items-center justify-center gap-2"
            >
              {isPending ? (
                <>
