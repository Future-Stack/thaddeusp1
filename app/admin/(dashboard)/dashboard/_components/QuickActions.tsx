            ...
            <AnimationWrapper animationType="fadeUp" delay={0.4} className="mb-8">
                <div className="bg-[#F8FBFF] rounded-2xl p-6 border border-[#E5EFFF] relative">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link href="/admin/lottery-event" className="flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 text-[#111827] rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors">
                            <ViewIcon />
                            View All Entries
                        </Link>
                    </div>
