...
const UserList = () => {
  ...
  const {
    ...
    isError,
    error,
  } = useGetUsers(page, limit, debouncedSearch);
            ...
            <table className="w-full">
              <thead>
                <tr className="text-left border-b border-gray-50">
                  <th className="pb-4 pt-2 text-[11px] font-bold text-gray-400 tracking-wider uppercase">
                    Full Name
                  </th>
                  <th className="pb-4 pt-2 text-[11px] font-bold text-gray-400 tracking-wider uppercase">
                    Email
                  ...
                  <th className="pb-4 pt-2 text-[11px] font-bold text-gray-400 tracking-wider uppercase text-right">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {isLoading ? (
                  ...
                  users.map((user: any) => (
                    ...
                    >
                      <td className="py-5 font-bold text-[#111827] text-sm">
                        {user.fullName}
                      </td>
          ...
          <div className="sm:hidden divide-y divide-gray-100">
            {isLoading ? (
              ...
              users.map((user: any) => (
                <div
                  key={user.id}
                  className="py-4 flex flex-col gap-2 hover:bg-gray-50/50 transition-colors px-1"
                >
