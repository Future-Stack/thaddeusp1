...
function Navbar() {
  ...
  const { user, accessToken, logout, role } = useAppStore();
                ...
                >
                  ...
                  <div className="hidden md:flex flex-col">
                    <div className="flex items-center gap-2">
                      <span className="font-bold  text-[#1C274C] text-[15px] leading-tight">
                        {user?.fullName || 'User'}
                      </span>
                      <svg
                        width="10"
                    ...
                    <span className="text-[#8E94A4] text-[12px] font-medium">
                      {user?.city || user?.region?.name || 'Location'}
                    </span>
                  </div>
                </div>
