  ...
  return (
    <div className="min-h-screen bg-[#FFFBF0] flex items-center justify-center p-4 relative overflow-hidden font-inter">
      ...
      <AnimationWrapper
        ...
        duration={0.8}
        className="w-full max-w-165 relative z-10"
      >
        <div className="bg-white rounded-4xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] p-8 md:p-12 border border-orange-50">
          ...
          <div className="text-center mb-10">
            ...
            <div className="bg-[#F1F3F6] p-1.5 rounded-full flex items-center justify-between w-full mx-auto mb-10">
              ...
              <Link
                href="/login"
                className="flex-1 py-3 text-sm font-bold text-gray-500 hover:text-gray-700 transition-all text-center"
              >
                Log In
              </Link>
            </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-6 py-2 bg-[#F8F9FA] border ${errors.fullName ? "border-red-500" : "border-primary"} rounded-xl focus:outline-none focus:border-primary/30 transition-all text-gray-700 placeholder:text-gray-400`}
              />
              {errors.fullName && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-6 py-2 bg-[#F8F9FA] border ${errors.email ? "border-red-500" : "border-primary"} rounded-xl focus:outline-none focus:border-primary/30 transition-all text-gray-700 placeholder:text-gray-400`}
              />
              {errors.email && (
                <p className="text-red-500 text-xs mt-1 ml-1 font-medium">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  {...register("password")}
                  placeholder="********"
                  className={`w-full px-6 py-2 bg-[#F8F9FA] border ${errors.password ? "border-red-500" : "border-primary"} rounded-xl focus:outline-none focus:border-primary/30 transition-all text-gray-700 placeholder:text-gray-400`}
                />
                <button
                  type="button"
                ...
                >
                  {showPassword ? (
                    ...
                    >
                      <path d="M9.88 9.88l-3.29-3.29m7.53 7.53l3.29 3.29M3 3l18 18M10.37 5.06l.23-.01a10 10 0 0 1 9.54 5.64 10 10 0 0 1-5.95 8.9m-5.15-.14a10 10 0 0 1-6.18-8.81 10 10 0 0 1 2.37-5.59M14.12 14.12a3 3 0 1 1-4.24-4.24" />
                    </svg>
                  ) : (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="********"
                  className={`w-full px-6 py-2 bg-[#F8F9FA] border ${errors.confirmPassword ? "border-red-500" : "border-primary"} rounded-xl focus:outline-none focus:border-primary/30 transition-all text-gray-700 placeholder:text-gray-400`}
                />
                <button
                  type="button"
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 bg-primary text-white font-medium text-[14px] rounded-xl shadow-[0_10px_25px_-5px_#EA730766] hover:bg-primary2 hover:shadow-[0_15px_30px_-5px_#EA730788] transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
              >
            ...
            <div className="relative py-3">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-4 text-gray-400 font-medium tracking-tight">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-white border border-gray-200 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-all duration-300 shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isGooglePending ? (
